...
Now that I have my data, geography, and OTP setup, I will create an isochrone depicting the 10 minute walkshed and bikeshed around each NYC museum I selected. I'll create several isochrones to test out various aesthetics, but each will depict the same walksheds and bikesheds. I want to give credit to Cristina Davila Gonzalez and her work on Assignment 1 for helping me to learn how to use different color palettes in my figures, which I have learned how to use for this assignment.
...
ggplot(iso_areas_2,
  ...
  scale_y_discrete(name = "Museums",
                   labels = c("American Museum of Natural History",
                              ...
                              "Solomon R. Guggenheim Museum",
                              "Studio Museum in Harlem")) +
  scale_fill_manual(name = "Area Covered by Walking and Biking",
                    values = wes_palette("GrandBudapest2", n = 2),
                    labels = c("Bicycle",
                               "Walk")) +
  theme_minimal()
