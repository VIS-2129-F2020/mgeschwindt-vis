...
For my map, I would like to create points as circles to represent each bicycle parking rack in Manhattan. Each of these circles will also have a label which includes the name of the street on which the bike is located.
